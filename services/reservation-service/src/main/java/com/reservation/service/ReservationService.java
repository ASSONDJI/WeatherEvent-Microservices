...
public class ReservationService {
    ...
    public PagedReservationResponse search(String city, String type, String status,
        ...
        Pageable pageable = buildPageable(page, size, sort);
        Page<Reservation> result = repository.search(city, type, status, userId, dateFrom, dateTo, pageable);
        return toPagedResponse(result);
    }
    ...
    public PagedReservationResponse getAllAdmin(String status, String type, String city, int page, int size, String sort) {
        Pageable pageable = buildPageable(page, size, sort);
        Page<Reservation> result = repository.search(city, type, status, null, null, null, pageable);
        return toPagedResponse(result);
    }
